...
client = MongoClient('mongodb+srv://PythonApp:4X0LUM8zjS7Q@researchcluster.usrji.mongodb.net/'
...
class Answers(Resource):
    ...
    def post(self):
        ...
        parser.add_argument(var1, type=str, choices=['female', 'male'], required=True, help='invalid input, gender'
                                                                                            ' must be male or female')
        parser.add_argument(var2, type=int, required=True, choices=[range(5, 101)], help='invalid input, age must '
                                                                                         'be number between 5 and 100')
